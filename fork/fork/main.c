...
#define SEMKEY1  1234           /* semaphore key No.1 */
#define SEMKEY2  4321           /* semaphore key No.1 */
#define SEMSIZE 1               /* semaphore key size */
...
static int parent = 1;          /* parent process running flag */
static int child = 1;           /* child process running flag */
static int semid1 = 0;          /* semaphore ID No.1 */
static int semid2 = 0;          /* semaphore ID No.2 */
static int shmid = 0;           /* shared memory ID */
static char *shmaddr = NULL;    /* shared memory address */
